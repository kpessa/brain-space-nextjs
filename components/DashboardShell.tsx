  ...
  return (
    <ClientProviders>
      <div className="min-h-screen bg-background flex flex-col w-full max-w-full overflow-x-hidden">
        ...
        {/* Main content */}
        <main className="flex-1 lg:pl-64 pb-16 sm:pb-0 overflow-y-auto overflow-x-hidden w-full max-w-full">
          <div className="px-4 py-8 sm:px-6 lg:px-8 min-h-full w-full max-w-full">
            {children}
          </div>
        </main>
